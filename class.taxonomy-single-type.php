<?php
if ( ! class_exists( 'Taxonomy_Single_Type' ) ) :
/**
 * Removes and replaces the built-in taxonomy metabox with <select> or series of <input type="radio" />
 *
 * Usage:
 *
 * $custom_tax_mb = new Taxonomy_Single_Type( 'custom-tax-slug', array( 'post_type' ), 'type' ); // 'type' can be 'radio' or 'select' (default: radio)
 *
...
class Taxonomy_Single_Type {
	...
	/**
	 * Taxonomy_Single_Type_Walker object
	 * @since 0.1.0
	 * @var object
	 */
	...
	/**
	 * Gets the Taxonomy_Single_Type_Walker object for use in term_fields_list and ajax_add_term
	 * @since 0.2.0
	 * @return object Taxonomy_Single_Type_Walker object
	 */
	public function walker() {
		if ( $this->walker ) {
			return $this->walker;
		}
		require_once( 'walker.taxonomy-single-type.php' );
		$this->walker = new Taxonomy_Single_Type_Walker( $this->taxonomy()->hierarchical, $this->input_element );
		return $this->walker;
	}
	/**
	 ...
	 *
	 * @return Taxonomy_Single_Type  Returns Taxonomy_Single_Type object, allows for chaining.
	 */
